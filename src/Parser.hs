...
-- The Expressions that are returned "primitive". The are entirely comprised
-- of elements such as boolean and numeric constants with the only compound
-- element being a "pair".
...
-- It takes a "primitive" Expression as input and converts it into more
-- sophisticated abstract tree syntax Expression such as Lambda, Application,
-- If, Define, etc.
